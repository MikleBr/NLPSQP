...
# deformationConstraint = Constraint(func=lambda params: deformationAnsysFunction.evaluate(params) - 0.002, type=ConstraintType.INEQ, name="Deformation < 0.002m")
...
task = OptimizationTask(
    variables=[
        # DesignVariable(name="r1", value=0.2, lower=0.001),
